#!/usr/bin/env python3
"""
Ultra-Fast Folder Processor Runner
Processes each folder individually with detailed speed tracking
"""
...
def compile_folder_processor():
    """Compile the folder processor"""
    print("\n🔨 Compiling Ultra-Fast Folder Processor...")
    
    cpp_file = "scripts/ultra_fast_folder_processor.cpp"
    output_file = "scripts/ultra_fast_folder_processor"
...
def run_folder_processor(data_dir, output_dir):
    """Run the compiled folder processor"""
    print(f"\n🚀 Running Ultra-Fast Folder Processor...")
    print(f"   📁 Input: {data_dir}")
    print(f"   📁 Output: {output_dir}")
    
    processor_path = "scripts/ultra_fast_folder_processor"
...
def main():
    """Main function"""
    print("🚀 Ultra-Fast Folder-by-Folder RML Processor")
    print("="*60)
    ...
    # Compile processor
    if not compile_folder_processor():
        print("❌ Compilation failed!")
        return False
    
    # Get directories
    data_dir = "data"
    output_dir = "output/folder_processing"
    
    # Confirm before running
    print(f"\n📋 Processing Plan:")
    print(f"   Input: {data_dir} (355GB)")
    print(f"   Output: {output_dir}")
    print(f"   This will process each folder individually with detailed progress")
    ...
    # Run processor
    success = run_folder_processor(data_dir, output_dir)
